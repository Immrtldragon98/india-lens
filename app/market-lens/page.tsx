...
export default async function MarketLensPage({searchParams}:{searchParams:Promise<{symbol?:string;question?:string}>}){
  ...
  return <main>
    ...
    <AdaptiveLearningBar/>
    <MarketLensAgent initialSymbol={incoming||undefined} initialQuestion={q.question} companies={marketCompanies.map(({symbol,name,sector,industry})=>({symbol,name,sector,industry}))}/>
  </main>
}
